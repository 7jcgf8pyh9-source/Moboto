...
export function HeartIcon({ className, size = 22 }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" className={className} {...base}>
      <path d="M12 20s-7-4.35-9.5-8.8C.8 7.9 2.4 4.5 6 4a5 5 0 0 1 6 2 5 5 0 0 1 6-2c3.6.5 5.2 3.9 3.5 7.2C19 15.65 12 20 12 20Z" />
    </svg>
  );
}
...
export function BookmarkIcon({ className, size = 22 }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" className={className} {...base}>
      <path d="M6.5 4h11a1 1 0 0 1 1 1v15l-6.5-4L5.5 20V5a1 1 0 0 1 1-1Z" />
    </svg>
  );
}
